...
### ODROID-C4
![Latest release](https://img.shields.io/github/v/release/odroid-dev/android-releases?filter=ODROID-C4_%2A&sort=date&display_name=tag&label=Latest%20release)

### ODROID-N2/N2+
![Latest release](https://img.shields.io/github/v/release/odroid-dev/android-releases?filter=ODROID-N2_%2A&sort=date&display_name=tag&label=Latest%20release)

### Total downloads: ![GitHub All Releases](https://img.shields.io/github/downloads/odroid-dev/android-releases/total?label=Total%20downloads:)
